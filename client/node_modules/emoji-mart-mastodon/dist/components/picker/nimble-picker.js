...
class NimblePicker extends _react.default.PureComponent {
  ...
  testStickyPosition() {
    ...
    prefixes.forEach(prefix => stickyTestElement.style.position = "".concat(prefix, "sticky"));
  ...
  handleSearch(emojis) {
    ...
    for (let i = 0, l = this.categories.length; i < l; i++) {
      let component = this.categoryRefs["category-".concat(i)];
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement("section", {
      ...
      return /*#__PURE__*/_react.default.createElement(_category.default, {
        ref: this.setCategoryRef.bind(this, "category-".concat(i)),
        key: category.name,
        id: category.id,
        name: category.name,
...
NimblePicker.defaultProps = { ..._sharedDefaultProps.PickerDefaultProps
};